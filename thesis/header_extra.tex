...
\usepackage{fontspec}
% \usepackage{helvet}
% \newfontfamily\mytitlefont{Helvetica}
\newfontfamily\mytitlefont{\sfdefault}
...
% \draw (current page.center) node[bag] {  
    ...
    \mytitlefont \color{titlecolor} \Large \textbf{Thesis} \\ 
    \\ 
    \mytitlefont \color{titlecolor} \Huge \textbf{\thetitle} \\ 
    \\ 
    \mytitlefont \color{titlecolor} \huge \theauthor \\
    \\
    \mytitlefont \color{titlecolor} \Large \thedate 
    };
\end{tikzpicture}
\clearpage}
...
% \draw (current page.center) node[bag] {  
    \draw (17, 1.7) node[bag, align=right, anchor=north east] {  
        \mytitlefont \color{titlecolor} \large Bioinformatics Research Centre \\ 
        \mytitlefont \color{titlecolor} \large Department of Molecular Biology and Genetics \\ 
        \mytitlefont \color{titlecolor} \large Aarhus University \\
        \mytitlefont \color{titlecolor} \large Universitetsbyen 81 \\
        \mytitlefont \color{titlecolor} \large 8000 Aarhus C \\
        \mytitlefont \color{titlecolor} \large Denmark
        };
