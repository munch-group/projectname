...
See plot @fig-danish-interaction below.

{{< embed ../notebooks/example.ipynb#fig-danish-interaction echo=false >}}

Or this really wide plot below (@fig-danish-interaction-facets).

:::{.column-page}
{{< embed ../notebooks/example.ipynb#fig-danish-interaction-facets echo=false>}}
:::
