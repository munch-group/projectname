...
flowchart LR
  A[Raw paired-end <br> reads] -- bwa, <br> bowtie2 <br> ... --> B[Mapped <br> pairs]
  B --> C{Identify <br> ligation <br> events}
  C --> CA[dangling-end <br> self-circle <br> weird]
  C --> CB[cis <br> trans]
  CA -. discard -->stop((( )))
  style stop fill:grey,stroke:white 
  CB -- deduplication, <br> parse, <br> mapq filter -->  CBA[<b>Hi-C matrix</b>]
```
