...
-- function skip_index (div)
-- -- if div.classes[1] == 'section' and pandoc.utils.stringify(div.content[1]) == 'Preface' then
--   if div.classes[1] == 'section' and div.attr.attributes.number == nil then
--         print(div.attr.attributes.number, pandoc.utils.stringify(div.content[1]))
--     return {}
--   end
-- end
...
function drop_noexport_sections (div)
  ...
  -- if div.attr.attributes.number == nil then
      return {}
  end
end
